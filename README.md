# Emulation of the *Drosophila Fly* Brain (plus body)

Note: This is a modification of code from the original authors, Shiu et al. (2023). and Eon systems.  This repository is pure experiment, and my modifications probably don't make much sense at all.  It's also heavily vibe-coded.  Use at your own risk.
